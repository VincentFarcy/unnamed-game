...
const Rest = ({ actionRest }) => (
  <div className="main__play">
    ...
    <p className="rest__texte">Vous restez tout de même sur vos gardes, il y a de nombreux bruits étranges sur le vaisseau... au loin vous pensez entendre une porte s'ouvrir... plus le temps passe plus vous avez l'impression de devenir fou ici. Vous avez récupéré quelques points de vies grâce à ce repos. Seulement, le temps passe et cela ne joue pas en votre faveur.</p>
