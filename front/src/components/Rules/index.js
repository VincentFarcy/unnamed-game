      ...
      <Card className="rules-intro">
        ...
        <Card.Body className="site-intro__body">
          ...
          <Card.Text className="site-intro__content">
            ...
            Ce genre d'humain ayant fait le choix de sacrifier une partie de l'humanité au
            profit de la technologie, a perdu le droit d'avoir une identité.
            Ainsi toutes les classes 4 s'appellent Unnamed, et paradoxalement les vrais
            androids les considèrent comme des humains.
          </Card.Text>
          <Card.Text className="site-intro__content">
            En 2154, l'humanité est entrée en contact pour la première fois avec
            une race extraterrestre : les Jaons. Cette rencontre a changé de façon
            drastique le monde.
            200 ans plus tard, la civilisation terrestre n'a cependant toujours pas résolu
            les soucis liés à son modèle économique défaillant. La Terre ayant atteint
            un point de "non-retour", le gouvernement mondial (une évolution apportée par
            les Jaons...) décida d'engager toutes les ressources possibles dans des missions
            ayant pour but de trouver une nouvelle planète d'accueil. Unnamed fait partie
            de l'une de ces missions.
          </Card.Text>
        </Card.Body>
      </Card>
    </section>
    ...
    <section className="introduction">
      <Card className="rules-intro">
        ...
        <Card.Body className="site-intro__body">
          ...
          <Card.Text className="site-intro__content">
            Point de Vie (PV) = (Constitution + (Volonté / 2)) X 10 --> Une fois à 0, vous
            avez perdu.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Initiative = (Agilité) --> En combat, sert de base de calcul pour définir qui
            agira le premier.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Toucher = (Agilité +(Intelligence / 3)) --> En combat, sert de base de calcul
            pour définir si vous touchez votre adversaire.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Esquive = (Agilité +(Intelligence / 2)) --> En combat, sert de base de calcul
            pour définir si vous esquivez une attaque de votre adversaire.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Dégâts = (Force) --> En combat, si vous avez touché votre adversaire, sert
            de base de calcul pour définir les PV qu'il va perdre.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Piratage = (Intelligence +(Volonté / 2)) --> En exploration, sert de base de
            calcul pour définir si vous arrivez à pirater le système de sécurité d'une porte.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Guérison = (Intelligence + Volonté) --> Sert de base de calcul pour définir les
            PV que vous allez gagner lors d'un repos.
          </Card.Text>
        </Card.Body>
      </Card>
    </section>
      ...
      <Card className="rules-intro">
        ...
        <Card.Body className="site-intro__body">
          ...
          <Card.Text className="site-intro__content">
            ...
            secondaire. Par exemple, lors d'un combat, vous avez votre valeur de "Toucher + 1D6"
            qui représentera votre valeur finale de toucher pour ce round.
          </Card.Text>
          <Card.Text className="site-intro__content">
    ...
    <section className="introduction">
      <Card className="rules-intro">
        ...
        <Card.Body className="site-intro__body">
          ...
          <Card.Text className="site-intro__content">
            Le combat est décomposé en rounds. Lors d'un round, la personne ayant eu
            l'initiative agit en premier. Les rounds se répétent tant qu'il reste des PV
            aux 2 antagonistes.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Lors d'un round, on commence par regarder si l'attaque touche. Si c'est le cas,
            alors on regarde combien de dégâts sont infligés, et on vient retirer ce
            montant des PV.
          </Card.Text>
          <Card.Text className="site-intro__content">
            Vous gagnez si votre adversaire tombe à 0 PV avant vous. Sinon
