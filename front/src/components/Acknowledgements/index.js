      ...
      <section>
        <Card className="site-intro">
          ...
          <Card.Body className="site-intro__body">
            ...
            Nous tenons également à remercier tous les membres de l'équipe O'clock et plus particulièrement nos professeurs et référants de formation et d'admission des promotions Asgard et Y !
            </Card.Text>
          </Card.Body>
        </Card>
      </section>
