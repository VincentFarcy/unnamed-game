        ...
        <Card className="site-intro">
          ...
          <Card.Body className="site-intro__body">
            ...
            <Card.Text className="site-intro__content">
              Nous sommes une équipe de 5 jeunes développeurs sortant d'une formation intensive de 5 mois
              au sein de l'école <a className="teamLink" href="https://oclock.io" alt="Ecole O'clock">O'clock </a>. 
              Nous avons pris beaucoup de plaisir dans l'élaboration de ce projet de fin de formation, et
              espérons que vous vous amuserez autant que nous avons pu le faire pendant la création du site.
            </Card.Text>
          </Card.Body>
        </Card>
      </section>
